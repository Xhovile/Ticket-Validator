    ...
    >
      ...
      >
        ...
        <div className="bg-slate-50 p-3 rounded-lg flex flex-col items-center justify-center space-y-1.5 border border-slate-200">
          ...
          <span className="font-mono text-[10px] font-medium text-slate-700 tracking-wider">
            {ticket.qrPayload}
          </span>
        </div>
        ...
        <div className="space-y-2.5 text-xs">
          ...
          <div className="grid grid-cols-2 gap-2 text-center">
            <div className="bg-slate-50 p-2 rounded-lg border border-slate-200">
              ...
              <p className="font-semibold text-blue-600 text-xs mt-0.5">{ticket.ticketTier}</p>
            </div>
            <div className="bg-slate-50 p-2 rounded-lg border border-slate-200">
              <p className="text-[10px] text-slate-500 font-medium uppercase">Zone / Seat</p>
              <p className="font-semibold text-slate-900 text-xs mt-0.5">{ticket.seatOrZone || 'General'}</p>
            </div>
          </div>
